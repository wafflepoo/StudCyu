...
export function LoginPage() {
  ...
  const demoUsers = [
    { email: 'student@demo.com', password: 'demo123', role: 'registered', name: 'Alex Student' },
    { email: 'premium@demo.com', password: 'demo123', role: 'premium', name: 'Sarah Premium' },
    { email: 'admin@demo.com', password: 'demo123', role: 'institutional', name: 'Dr. Admin' },
  ];
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Label className="text-sm text-muted-foreground">Quick Demo Login:</Label>
              <div className="grid grid-cols-3 gap-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => quickLogin('institutional')}
                  className="text-xs"
                >
                  Admin
                </Button>
